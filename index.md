...
* **I-SDC:** A [POS](https://en.wikipedia.org/wiki/Point_of_sale) / CIS (it can be a device or an application) able to communicate with its own SE (a SAM card) through the [APDU API](https://avatartechnologies.github.io/integrators/Avatar_APDU_v1_5.pdf).
...
* [APDU API](https://avatartechnologies.github.io/integrators/Avatar_APDU_v1_5.pdf)
* [Avatar API](https://avatartechnologies.github.io/integrators/AVATARAPIDOCUMENTATION.pdf)
